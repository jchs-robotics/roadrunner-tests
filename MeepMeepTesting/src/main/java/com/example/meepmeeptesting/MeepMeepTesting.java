...
public class MeepMeepTesting {
    ...
    public static double sampleOneX = -37;
    public static double sampleOneY = -25;
    public static double sampleTwoX = -47;
    public static double sampleTwoY = -25;
    public static double sampleThreeX = -57;
    public static double sampleThreeY = -25;
